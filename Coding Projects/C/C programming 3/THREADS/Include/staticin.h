...
#define USERMODE   psr_set(psr_get() & ~PSR_CURRENT_MODE)
...
/* ************************************************************************
   Name - DebugConsole
   Purpose - Prints  the message to the ConsoleOutput if in debug mode
...
static inline void checkKernelMode(const char* functionName)
{
    ...
    psrValue.integer_part = GetPsr();
    if (psrValue.bits.cur_mode == 0)
    {
        ConsoleOutput(FALSE, "Kernel mode expected, but function called in user mode.\n");
        Stop(1);
    }
}
...
/* ************************************************************************
   ...
   Side Effects -
   ----------------------------------------------------------------------- */
static void* ListGetPreviousNode(List* pList, void* pCurrentStucture)
{
    void* pNode = NULL;
    ListNode* pCurrentNode;  // Node part of the current structure
    int listOffset;
...
/* ************************************************************************
   ...
   Side Effects -
   ----------------------------------------------------------------------- */
static void* ListGetClosestNode(List* pList, void* pCurrentStucture)
{
    void* pNode = NULL;
    ListNode* pCurrentNode;  // Node part of the current structure
    int listOffset;
